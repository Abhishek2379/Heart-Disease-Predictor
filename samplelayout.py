...
#Age
c1 = StringVar()
fname=Label(genframe,text='Age', font="Calibri 15",bg="whitesmoke").place(x=300,y=180)
firstname=Entry(genframe,width=30,textvariable=c1).place(x=420,y=185)

#Sex
c2 = StringVar()
mname=Label(genframe,text='Sex(M:1,F:0)', font="Calibri 15",bg="whitesmoke").place(x=300,y=220)
middlename=Entry(genframe,width=30,textvariable=c2).place(x=420,y=225)

#Chest Pain Type
c3 = StringVar()
lname=Label(genframe,text='CPT(1-4)', font="Calibri 15",bg="whitesmoke").place(x=300,y=260)
lastname=Entry(genframe,width=30,textvariable=c3).place(x=420,y=265)

#Resting Blood Pressure
dob1=Label(genframe,text="RestingBP", font="Calibri 15",bg="whitesmoke").place(x=300,y=300)
c4 = StringVar()
dateofbirth=Entry(genframe,width=30,textvariable=c4).place(x=420,y=305)

#Serum Cholestrol
c5=StringVar()
branch=Label(genframe,text='SC(>100)', font="Calibri 15",bg="whitesmoke").place(x=300,y=340)
brbox=Entry(genframe,width=30,textvariable=c5).place(x=420,y=345)

#Fasting Blood Sugar
c6=StringVar()
year=Label(genframe,text='FBS(Y:1,N:0)', font="Calibri 15",bg="whitesmoke").place(x=300,y=380)
yrbox=Entry(genframe,width=30,textvariable=c6).place(x=420,y=385)

#Resting ECG
c7=StringVar()
roll=Label(genframe,text='R-ECG(0-2)', font="Calibri 15",bg="whitesmoke").place(x=300,y=420)
rnbox=Entry(genframe,width=30,textvariable=c7).place(x=420,y=425)

#Maximum Heart Rate
c8=StringVar()
mobno=Label(genframe,text='MaxHR', font="Calibri 15",bg="whitesmoke").place(x=700,y=180)
mnbox=Entry(genframe,width=30,textvariable=c8).place(x=820,y=185)

#Exercise Induced Angina
c9=StringVar()
mobno=Label(genframe,text='EIA(Y:1,N:0)', font="Calibri 15",bg="whitesmoke").place(x=700,y=220)
mnbox=Entry(genframe,width=30,textvariable=c9).place(x=820,y=225)

#OldPeak
c10=StringVar()
mobno=Label(genframe,text='OP(0.0-5.0)', font="Calibri 15",bg="whitesmoke").place(x=700,y=260)
mnbox=Entry(genframe,width=30,textvariable=c10).place(x=820,y=265)

#Slope of the peak
c11=StringVar()
mobno=Label(genframe,text='SOP(1-3)', font="Calibri 15",bg="whitesmoke").place(x=700,y=300)
mnbox=Entry(genframe,width=30,textvariable=c11).place(x=820,y=305)

#Number of Major Vessels
c12=StringVar()
mobno=Label(genframe,text='NoMV(0-3)', font="Calibri 15",bg="whitesmoke").place(x=700,y=340)
mnbox=Entry(genframe,width=30,textvariable=c12).place(x=820,y=345)

#Thal
c13=StringVar()
mobno=Label(genframe,text='Thal(3/6/7)', font="Calibri 15",bg="whitesmoke").place(x=700,y=380)
mnbox=Entry(genframe,width=30,textvariable=c13).place(x=820,y=385)
...
title=Label(titleframe,text="Prediction System(HDP)",font="Calibri 25 bold",bg="lightgrey",fg="deepskyblue2").grid(column=0,row=0)
##Menu
